...
public class VentaPDF {
    ...
    public void DatosCliente(int idClientes) {
        Connection cn = Conexion.conectar();
        String sql = "select * from tb_clientes where idClientes = '" + idClientes + "'";
        Statement st;
        try {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String ruc = "23578927345";
            String nombre = "Javi Cooporation";
            String telefono = "ExampleNumber";
            String direccion = "Spain";
            String razon = "Imprimiendo Factura";
