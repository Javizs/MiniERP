        ...
        try {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "select idClientes, concat(nombre, ' ', apellido) as nombres, cedula, telefono, direccion from tb_clientes");
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "select cv.idCabeceraVenta as id, concat(c.nombre, ' ', c.apellido) as cliente, "
                                ...
                                + "from tb_cabecera_venta as cv, tb_clientes as c "
                                + "where cv.idCliente = c.idClientes;");
                ResultSet rs = pst.executeQuery();
                if (rs.next()) {
                    do {
                        tabla.addCell(rs.getString(1));
